  ...
  return (
    <section className="w-full bg-white mt-12">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-[#010b1a] text-white rounded-3xl p-6 sm:p-8 lg:p-10 shadow-lg flex flex-col sm:flex-row items-center justify-between gap-6">
          ...
          <form className="w-full sm:w-auto flex flex-col sm:flex-row items-center gap-3" onSubmit={(e) => e.preventDefault()}>
            <input
              ...
              className="h-10 w-full sm:w-64 px-3 rounded-sm border border-white/20 text-[#01162E] bg-white/95 placeholder:text-zinc-400"
            />
            <button
              type="submit"
