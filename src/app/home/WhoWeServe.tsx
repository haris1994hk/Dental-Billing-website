    ...
    <section className="w-full bg-white mt-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="relative grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
          {/* Left card */}
          <div className="bg-[#e9f3ff] rounded-3xl p-8 shadow-md">
            <h3 className="text-[34px] font-extrabold text-[#1B489B] tracking-wide mb-6">WHO WE SERVE?</h3>
            <ul className="list-disc pl-6 space-y-4 text-[#0f1724] font-semibold">
          ...
          <div className="relative">
            <div className="absolute right-20 -top-8 lg:-top-12 transform lg:translate-x-12">
            ...
            <div className="bg-[#e9f3ff] rounded-3xl p-8 shadow-md mt-24">
